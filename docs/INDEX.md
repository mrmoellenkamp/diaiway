...
| [SECURITY.md](../SECURITY.md) | Security-Policy: Responsible Disclosure, Bedrohungsmodell, Rate-Limits pro Route, CSP (Next.js-kompatibel), signierte Blob-URLs, Secret-Rotation |
...
*Letzte Aktualisierung: April 2026 – Security-Hardening (Rate-Limits, CSP ohne Nonce, signierte Blob-URLs, Upstash-Guest-Store); siehe [SECURITY.md](../SECURITY.md)*
