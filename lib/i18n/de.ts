const de = {
  ...
  "video.prejoinHint": "Kamera und Mikro prüfen, dann auf „Beitreten“ klicken",
  ...
  "safety.gatewayDescVoice": "Bitte bestätige die folgenden Punkte, bevor du den Call betrittst.",
  "safety.gatewayDescVoice": "Bitte bestätige die folgenden Punkte, bevor du den Call betrittst.",
  ...
  "safety.checkSnapshotConsent": "Ich willige ein, dass zur Sicherheit automatisierte Stichproben-Snapshots erstellt und bei Richtlinienverstößen zur Beweissicherung gespeichert werden.",
  "safety.confirm": "Ich bestätige und möchte beitreten",
  "safety.takumiNotice": "diaiway Safety Enforcement ist aktiv. Du wirst durch automatisierte Pre-Checks und Live-Monitoring geschützt.",
  "safety.preCheckRunning": "Pre-Check läuft…",
  "safety.preCheckFailed": "Der Pre-Check konnte nicht bestanden werden. Bitte halte dich an die Verhaltensregeln.",
  "safety.preCheckError": "Fehler beim Pre-Check. Bitte versuche es erneut.",

  "precheck.deviceSetup": "Bild & Ton einrichten",
  "precheck.cameraSelect": "Kamera",
  "precheck.micSelect": "Mikrofon",
  "precheck.cameraDefault": "Kamera {n}",
  "precheck.micDefaultLabel": "Mikrofon {n}",
  "precheck.micDefault": "Standardmikrofon",
  "precheck.deviceLoading": "Geräte werden geladen…",
  "precheck.deviceError": "Zugriff auf Kamera/Mikrofon verweigert.",
  "precheck.deviceHint": "Bitte erlaube den Zugriff in den Browser-Einstellungen und lade die Seite neu.",
  ...
  "booking.videoSessionOption": "Video-Session",
  "booking.voiceCallOption": "Voice-Call",
  "booking.callTypeTitle": "Call-Typ wählen",
