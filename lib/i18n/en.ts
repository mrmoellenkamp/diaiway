const en = {
  ...
  "mentor.headerTitleFloating": "Project Mentor",
  ...
  "video.prejoinHint": "Check camera and microphone, then click „Join“",
  ...
  "safety.gatewayDescVoice": "Please confirm the following before entering the call.",
  "safety.gatewayDescVoice": "Please confirm the following before joining the call.",
  ...
  "safety.checkSnapshotConsent": "I consent that for safety, automated random snapshots are created and saved for evidence in case of policy violations.",
  "safety.confirm": "I confirm and want to join",
  "safety.takumiNotice": "diaiway Safety Enforcement is active. You are protected by automated pre-checks and live monitoring.",
  "safety.preCheckRunning": "Pre-check in progress…",
  "safety.preCheckFailed": "The pre-check could not be passed. Please adhere to the code of conduct.",
  "safety.preCheckError": "Pre-check error. Please try again.",

  "precheck.deviceSetup": "Set up picture & sound",
  "precheck.cameraSelect": "Camera",
  "precheck.micSelect": "Microphone",
  "precheck.cameraDefault": "Camera {n}",
  "precheck.micDefaultLabel": "Microphone {n}",
  "precheck.micDefault": "Default microphone",
  "precheck.deviceLoading": "Loading devices…",
  "precheck.deviceError": "Camera/microphone access denied.",
  "precheck.deviceHint": "Please allow access in your browser settings and reload.",
  ...
  "takumiPage.contactChat": "Send a message now",
  "takumiPage.preparingChat": "Preparing chat...",
  "takumiPage.directMessage": "Direct message to {name}",
  ...
  "booking.callTypeTitle": "Choose call type",
