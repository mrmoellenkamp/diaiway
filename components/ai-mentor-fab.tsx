      ...
      {isOpen && (
        <div
          className={cn(
            ...
            isInApp
              ? "bottom-24 max-h-[calc(100vh-10rem)]"
              : "bottom-4 max-h-[calc(100vh-2rem)]"
          )}
          role="dialog"
        ...
        >
          ...
          <button
            ...
            className="absolute right-3 top-3 z-10 flex size-7 items-center justify-center rounded-full bg-white/30 backdrop-blur-sm text-muted-foreground transition-colors hover:bg-white/50 hover:text-foreground"
