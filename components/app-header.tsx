...
export function AppHeader({ title }: { title?: string }) {
  ...
  return (
    <header className="sticky top-0 z-50 isolate border-b border-border bg-[rgba(255,255,255,0.95)] backdrop-blur-md pointer-events-auto pt-[env(safe-area-inset-top,0px)]">
        ...
        <Link href="/" className="flex min-h-11 min-w-11 items-center justify-center gap-2 -m-1 p-1 rounded-lg hover:bg-[rgba(245,245,244,0.5)] active:bg-muted transition-colors touch-manipulation">
