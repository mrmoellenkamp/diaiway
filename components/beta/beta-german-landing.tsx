...
export function BetaGermanLanding() {
  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-900">
      {/* Hero: quadratisches Motiv 1:1, object-contain — kein Stauchen, kein Beschnitt; Hintergrund weiß */}
      <section className="relative bg-white pb-3 pt-[max(0.5rem,env(safe-area-inset-top,0px))] md:pb-6">
        ...
        {/* Kompakt, damit Badge + Headline + Textanfang ohne Scroll sichtbar */}
      ...
      <article className="mx-auto max-w-2xl px-4 pt-4 pb-8 md:pt-6 md:pb-12">
        ...
        <section className="mt-14 flex flex-col gap-5 rounded-2xl border border-stone-200 bg-white p-5 shadow-sm md:flex-row md:items-center md:gap-8 md:p-8">
          ...
          <div className="min-w-0 text-center md:text-left">
            ...
            <p className="mt-1 text-lg font-bold text-stone-900">Jens von diAiway</p>
          </div>
        </section>
      </article>
