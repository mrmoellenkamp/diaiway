...
-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('pending', 'confirmed', 'active', 'completed', 'declined', 'cancelled', 'cancelled_in_handshake', 'instant_expired');
...
CREATE TABLE "User" (
    ...
    "verificationSource" "VerificationSource" NOT NULL DEFAULT 'NONE',
    "tokenRevocationTime" INTEGER,
    "moderationViolationAt" TIMESTAMP(3),
...
-- CreateTable
CREATE TABLE "DailyParticipantLeft" (
    "id" TEXT NOT NULL,
    "room" TEXT NOT NULL,
    ...
    CONSTRAINT "DailyParticipantLeft_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "DailyParticipantLeft_room_idx" ON "DailyParticipantLeft"("room");

-- CreateIndex
CREATE INDEX "DailyParticipantLeft_leftAt_idx" ON "DailyParticipantLeft"("leftAt");
